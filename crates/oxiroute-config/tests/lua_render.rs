...
use oxiroute_config::{
    ...
    RtmpRecordMask, RtmpRecorder, RtmpRecorderSegmentNaming, RtmpRecorderStart,
    RtmpRecorderTimeBasis, RtmpRecorderTimezone, RtmpService, RtmpSessionCeilings, TlsPolicy,
        ...
        applications: vec![RtmpApplication {
            ...
            recorders: vec![
                RtmpRecorder {
                    ...
                    record_mask: RtmpRecordMask::default(),
