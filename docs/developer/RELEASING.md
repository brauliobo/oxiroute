...
```sh
./scripts/verify-release-version.sh 0.5.2
./scripts/create-release-archive.sh /tmp/oxiroute-0.5.2.tar.gz 0.5.2
./scripts/verify-release-archive.sh /tmp/oxiroute-0.5.2.tar.gz 0.5.2 --compare-worktree
```
