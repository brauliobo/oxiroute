...
| CONNECT tunnels | implemented | Authority parsing, exact approved-address connection, unsplit bounded duplex relay, half-close, byte/idle/lifetime limits, and shutdown cancellation are wire- and host-shadow-tested. |
