...
fn parse_acl(directive: &Directive) -> Option<AclDefinition> {
...
fn parse_http_return_rule(arguments: &[super::Word]) -> Option<HttpRequestRule> {
...
fn parse_http_response_rule(arguments: &[super::Word]) -> Option<HttpResponseRule> {
    match arguments {
...
fn parse_forward_for(arguments: &[super::Word]) -> Option<ForwardFor> {
...
fn parse_http_check(arguments: &[super::Word]) -> Option<HttpCheck> {
    match arguments {
        [] => Some(HttpCheck {
...
fn parse_status_ranges(value: &[u8]) -> Option<Vec<StatusRange>> {
