...
pub use resolver::{
    ...
    ReferenceTarget, RetryOn, RetryOnTrigger, SectionId, SemanticBlocker, SemanticBlockerKind,
    ServerAddress, ServerOption, StatsAdminPolicy, StatsSettings, StatusRange, Timeouts, TlsAlpn,
